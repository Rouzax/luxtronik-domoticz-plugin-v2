...
<plugin key="luxtronikex" name="Luxtronik Heat Pump Controller v2" author="Rouzax" version="2.2.0" externallink="https://github.com/Rouzax/luxtronik-domoticz-plugin-v2">
    <description>
