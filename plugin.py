...
<plugin key="luxtronikex" name="Luxtronik Heat Pump Controller v2" author="Rouzax" version="2.0.3">
    <description>
...
# =============================================================================
# Type aliases and base classes are defined in converters.py and imported above.
